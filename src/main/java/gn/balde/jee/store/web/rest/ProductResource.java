package gn.balde.jee.store.web.rest;

import gn.balde.jee.store.domain.Product;
import gn.balde.jee.store.repository.ProductRepository;
import gn.balde.jee.store.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link gn.balde.jee.store.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
